...
THREEx.Planets.createEarth = function() {
  var geometry = new THREE.SphereGeometry(0.5, 32, 32)
  var material = new THREE.MeshPhongMaterial({
    map: THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL + 'images/1_earth_8k.jpg'),
    bumpMap: THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL + 'images/elev_bump_8k.jpg'),
    bumpScale: 0.00065,
...
THREEx.Planets.createEarthCloud = function() {
  ...
  imageMap.src = THREEx.Planets.baseURL + 'images/fair_clouds_8k.jpg';
...
THREEx.Planets.createStarfield = function() {
  var texture = THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL + 'images/starfield.jpg')
